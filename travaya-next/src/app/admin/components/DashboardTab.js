        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={i} className="bg-card border border-border-custom rounded-3xl p-6 shadow-sm hover:border-primary/30 transition-all group relative overflow-hidden">
                         ...
                         <div className="relative z-10 flex flex-col gap-4">
                            <div className="flex justify-between items-center">
                                ...
                                <div className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-lg ${metric.isUp ? 'text-green-500 bg-green-500/10' : 'text-red-500 bg-red-500/10'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-card border border-border-custom rounded-[2.5rem] p-8 shadow-sm space-y-8">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-gray-500">Volume of reservations across the current period</p>
                        </div>
                    </div>
                ...
                <div className="bg-card border border-border-custom rounded-[2.5rem] p-8 shadow-sm space-y-8">
                     <div className="space-y-1">
                        <h3 className="text-xl font-bold flex items-center gap-2">
                            <MapIcon className="text-secondary" size={20} />
                            Popularity
                        </h3>
                         <p className="text-xs text-gray-500">Most booked destinations</p>
                    </div>
                    <div className="h-[240px] relative flex items-center justify-center">
                        ...
                        <div className="absolute flex flex-col items-center">
                            ...
                            <span className="text-2xl font-black italic text-primary">DEST</span>
                        </div>
                    </div>
                </div>
                
                <div className="lg:col-span-3 bg-card border border-border-custom rounded-[2.5rem] p-8 shadow-sm space-y-8">
                    <div className="space-y-1">
                        <h3 className="text-xl font-bold flex items-center gap-2">
                    ...
                    <div className="h-[200px] w-full max-w-xl mx-auto">
                        <Bar 
                            data={verificationData} 
                            options={{ ...chartOptions, indexAxis: 'y', scales: { x: { display: false }, y: { grid: {display: false}, ticks: {color: chartColors.text, font: {size: 12, weight: 'bold'}} } } }} 
                        />
                    </div>
                </div>
            </div>
